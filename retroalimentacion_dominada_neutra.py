# Retroalimentación en tiempo real para dominada con agarre neutro.
import os
import cv2
import numpy as np
import joblib
...
from core.dinamica import vel_ang, acc_ang, mean_safe, min_safe, max_safe
...
RUTA_VIDEO = os.path.join(config.RAIZ, "video_resultado_final.mp4")
