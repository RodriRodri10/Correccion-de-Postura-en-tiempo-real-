# Entrenamiento Wall Push-Up: extrae ángulos por repetición y entrena el modelo de fase.
import os
import cv2
import numpy as np
import pandas as pd
...
from core.senales import suavizar_kalman

# ---------- CONFIG ----------
CARPETA_CORRECTOS = config.VIDEOS_WALL_PUSHUP
CARPETA_SALIDA = config.DIR_WALL_PUSHUP
    ...
    with nueva_pose() as pose:
        while cap.isOpened():
            ...
            if res.pose_landmarks:
                ...
                # Inclinación del tronco respecto a la vertical desde la cadera.
                # (Antes usaba (hombro, cadera, cadera) -> vector nulo -> siempre 0°.)
